...
<%  
boolean status=appUserDao.getRecordByIdForJoin(u);  
    ...
    <div class="container">
		<div class="patient-details">
            ...
            <div class="doctor-details" style="float: right;">
                ...
                <div class="photo">
                    <img src="https://cdn3d.iconscout.com/3d/premium/thumb/doctor-avatar-10107433-8179550.png?f=webp" alt="Doctor Photo" >
                </div>
                <div class="det">
            ...
            <h2 align="center">Photo</h2>
                <div class="photo" >
                    <img src="https://image.freepik.com/free-vector/doctor-patient_42515-289.jpg" alt="Patient Photo">
                </div>
            </div>
